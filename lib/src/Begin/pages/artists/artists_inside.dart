...
// class Artists_inside extends StatefulWidget {
//   @override
//   _Artists_insideState createState() => _Artists_insideState();
// }
      ...
      body: Container(
        ...
        child: Container(
          ...
          : ClampingScrollPhysics(),
            slivers: <Widget>[
              // Padding(padding: EdgeInsets.only(top: deviceHeight / 6)),
              SliverAppBar(
                // floating: true,
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: Column(
                    children: [
                      ...
                      Container(
                        // padding: EdgeInsets.only(top: deviceHeight / 12),
