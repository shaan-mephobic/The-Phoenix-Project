      ...
      return GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            childAspectRatio: orientedCar
                ? (deviceHeight / 4) / (deviceHeight / 4 + deviceHeight / 16)
            ...
            child: InkWell(
              ...
              onTap: () async {
                ...
                if (musicBox.get("mapOfArtists") != null &&
                    musicBox.get("mapOfArtists")[allArtists[index]] != null) {
                  if (musicBox.get("colorsOfArtists") == null
                      ? true
                      : musicBox.get("colorsOfArtists")[allArtists[index]] ==
                          null) {
                    try {
                    ...
                    print("IAMSPEED!!!");
                    dominantAlbum = Color(
                        musicBox.get("colorsOfArtists")[allArtists[index]][0]);
                    contrastAlbum = Color(
                        musicBox.get("colorsOfArtists")[allArtists[index]][1]);
                  }
                } else {
                  contrastAlbum = Colors.white;
                  dominantAlbum = kMaterialBlack;
